  ...
  <div class="person">
    <a-form layout="inline">
      <a-form-item label="姓名">
        <a-input allowClear @pressEnter="onSearch" v-model:value="form.name" placeholder="请输入"></a-input>
      </a-form-item>
      <a-form-item label="所属学期">
        <a-select placeholder="选择学期" allowClear v-model:value="form.semesterId" style="width: 172px">
    ...
    <a-table :loading="loading" rowKey="id" :dataSource="users" :columns="columns" :pagination="false">
...
import { getWechatUserListByPage, deleteUser, RequestParams, Users } from "../../modules/wechatUser.modules";
